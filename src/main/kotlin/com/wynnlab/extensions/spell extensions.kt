...
fun sound(l: Location, sound: Sound, volume: Float, pitch: Float) {
...
fun BaseMobSpell.damage(e: LivingEntity, melee: Boolean = false, multiplier: Double = 1.0, vararg conversion: Double) =
    damage(mob as LivingEntity, e, melee, multiplier, conversion)
fun damage(source: LivingEntity, e: LivingEntity, melee: Boolean = false, multiplier: Double = 1.0, conversion: DoubleArray = DoubleArray(0)) =
    Bukkit.getPluginManager().callEvent(DamageEvent(source, e, melee, multiplier, conversion))
